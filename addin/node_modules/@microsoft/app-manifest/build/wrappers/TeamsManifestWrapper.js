...
class TeamsManifestWrapper {
    ...
    get declarativeAgents() {
        return this._data.copilotAgents?.declarativeAgents ?? [];
    }
    /**
     * Returns a readonly array of custom engine agents.
     */
    get customEngineAgents() {
        return this._data.copilotAgents?.customEngineAgents ?? [];
    }
    // ============= Setters (Fluent API) =============
    /**
     * Sets the app ID.
    ...
    addSkill(folder) {
        ...
        if (skills.length >= TeamsManifestWrapper.MAX_AGENT_SKILLS) {
            console.warn(`Maximum ${TeamsManifestWrapper.MAX_AGENT_SKILLS} agent skills allowed. Ignoring addition.`);
            return this;
        }
